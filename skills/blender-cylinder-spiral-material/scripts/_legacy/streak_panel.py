...
class VIEW3D_PT_streak(bpy.types.Panel):
    bl_label = '滚筒斜纹材质'
    bl_idname = 'VIEW3D_PT_streak'
...
def register():
    try:
        bpy.utils.unregister_class(VIEW3D_PT_streak)
    except Exception:
        pass
    bpy.utils.register_class(VIEW3D_PT_streak)

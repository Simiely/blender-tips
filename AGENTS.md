...
> 📌 **文档基线**:2026-09-13 v1.17.1 —— 按材质拆分验证器「孤儿 mesh」判据由绝对判无改为**基线差集**(含兼容旧基线分支);
> 前序 v1.17.0(commit `ba8d942`) 渲染发黑与材质不发光排查(#35)+Skill `blender-render-blackout-diagnose`+材质覆盖/孤儿 BSDF/BOM 三条坑
